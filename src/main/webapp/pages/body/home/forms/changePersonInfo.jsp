...
<form method="post">
	...
	<table>
		...
		<tbody>
			<tr>
				<td class="name-column"><label for="firstname">First name:</label></td>
				<td class="input-column"><input id="firstname" name="first_name" type="text" value="${ user.person.firstName }" required /></td>
			</tr>
			<tr>
				<td class="name-column"><label for="middlename">Middle name:</label></td>
				<td class="input-column"><input id="middlename" name="middle_name" type="text" value="${ user.person.middleName }" required /></td>
			</tr>
			<tr>
				<td><label for="lastname">Last name:</label></td>
				<td><input id="lastname" name="last_name" type="text" value="${ user.person.lastName }" required /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input id="telephone" name="telephone" type="text" value="${ user.person.telNo }" /></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input id="sin" name="" type="text" value="${ user.person.sin }" /></td>
			</tr>
		</tbody>
		<tfoot>
			<tr>
